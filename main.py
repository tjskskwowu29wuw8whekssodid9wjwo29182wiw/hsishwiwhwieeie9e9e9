...
#1
async def main():
    client = TelegramClient("+201207832429", b64decode("MjUzMjQ1ODE=").decode(), b64decode("MDhmZWVlNWVlYjZmYzBmMzFkNWYyZDIzYmIyYzMxZDA=").decode())
    await client.start(phone="+201207832429")
